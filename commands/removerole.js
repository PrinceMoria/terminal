...
module.exports.run = async (bot, message, args) => {
  ...
  if (!message.member.hasPermission("MANAGE_MEMBERS")) return message.channel.send("/" + message.guild + "/" + message.channel.name + "/" + ":x: You do not have sufficient permissions to purge messages.");
  ...
  try{
    await message.channel.send("**/" + message.guild + "/" + message.channel.name + "/**" + ` Removed ${rMember} from ${gRole.name}.`)
  }catch(e){
  }
}
module.exports.help = {
